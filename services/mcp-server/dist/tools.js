...
export const tools = [
    ...
    {
        name: "teamup_login",
        description: "Login to TeamUp and get an authentication token. Use this token for authenticated requests.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Get information about the currently authenticated user. Requires authentication token.",
        inputSchema: {
            type: "object",
            properties: {
                token: {
    ...
    // ==================== VENUES ====================
    {
        ...
        description: "Search for sports venues with available time slots. Can filter by location, sport type, and date/time.",
        inputSchema: {
            type: "object",
            properties: {
                lat: {
                ...
                datetime: {
                    type: "string",
                    description: "Filter by date/time (ISO format: YYYY-MM-DD or YYYY-MM-DDTHH:MM:SS)",
                },
                sport_type: {
                    type: "string",
                    description: "Filter by sport type (e.g., basketball, tennis, badminton)",
                },
            },
        },
    },
    ...
    },
    {
        ...
        description: "Get available time slots for a specific court at a venue. Can filter by date.",
        inputSchema: {
            type: "object",
            properties: {
                venue_id: { type: "string", description: "UUID of the venue" },
    ...
    // ==================== EVENTS ====================
    {
        ...
        description: "List and search TeamUp events. Can filter by status, visibility, and search by keyword.",
        inputSchema: {
            type: "object",
            properties: {
                status: {
    ...
    },
    {
        ...
        description: "Get detailed information about a specific TeamUp event including participants.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Create a new TeamUp event. The creator becomes the event owner. Requires authentication.",
        inputSchema: {
            type: "object",
            properties: {
                token: {
                ...
                duration_type: {
                    ...
                    description: "Whether this is a one-time or recurring event (default: temporary)",
                },
            },
    ...
    },
    {
        ...
        description: "Update an existing TeamUp event. Only the event owner can update. Requires authentication.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Get events created by the authenticated user. Requires authentication.",
        inputSchema: {
            type: "object",
            properties: {
                token: { type: "string", description: "Authentication token" },
    ...
    },
    {
        ...
        description: "Get events the authenticated user has joined as a participant. Requires authentication.",
        inputSchema: {
            type: "object",
            properties: {
                token: { type: "string", description: "Authentication token" },
    ...
    // ==================== JOIN REQUESTS ====================
    {
        ...
        description: "Request to join a TeamUp event. Requires authentication. The event owner will need to approve.",
        inputSchema: {
            type: "object",
            properties: {
                token: { type: "string", description: "Authentication token" },
    ...
    },
    {
        ...
        description: "Get pending join requests for events you own. Requires authentication.",
        inputSchema: {
            type: "object",
            properties: {
                token: { type: "string", description: "Authentication token" },
    ...
    },
    {
        ...
        description: "Approve or reject a join request for your event. Requires authentication as the event owner.",
        inputSchema: {
            type: "object",
            properties: {
                token: { type: "string", description: "Authentication token" },
    ...
    // ==================== BOOKINGS ====================
    {
        ...
        description: "List the authenticated user's bookings. Requires authentication.",
        inputSchema: {
            type: "object",
            properties: {
                token: { type: "string", description: "Authentication token" },
    ...
    },
    {
        ...
        description: "Book a time slot for a TeamUp event. Only the event owner can book. Requires authentication.",
        inputSchema: {
            type: "object",
            properties: {
                token: { type: "string", description: "Authentication token" },
    ...
    // ==================== TICKETS ====================
    {
        ...
        description: "List the authenticated user's matching tickets. Requires authentication.",
        inputSchema: {
            type: "object",
            properties: {
                token: { type: "string", description: "Authentication token" },
    ...
    },
    {
        ...
        description: "Create a matching ticket to find playing partners. The system will match you with others who have compatible tickets.",
        inputSchema: {
            type: "object",
            properties: {
                token: { type: "string", description: "Authentication token" },
    ...
    // ==================== NOTIFICATIONS ====================
    {
        ...
        description: "Get the authenticated user's notifications. Requires authentication.",
        inputSchema: {
            type: "object",
            properties: {
                token: { type: "string", description: "Authentication token" },
