...
describe("API Client", () => {
    ...
    describe("apiRequest", () => {
        ...
        it("should throw error on non-ok response", async () => {
            ...
            await expect(apiRequest("/auth/me")).rejects.toThrow("API Error 401: Unauthorized");
        });
        it("should throw error on 404 response", async () => {
            ...
            await expect(apiRequest("/events/unknown-id")).rejects.toThrow("API Error 404: Not found");
        });
        it("should throw error on 500 response", async () => {
            ...
            await expect(apiRequest("/events")).rejects.toThrow("API Error 500: Internal server error");
        });
