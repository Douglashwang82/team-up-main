...
export default function TeamUpDetailPage() {
  ...
  const isOwner = user && teamup && teamup.ownerUserId === user.id;
  const isParticipant = teamup?.participants?.some(p => p.userId === user?.id);
  ...
  const progress = Math.min((teamup.currentParticipants / teamup.maxParticipants) * 100, 100);
                  ...
                  {teamup.participants.map((participant) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-semibold text-gray-900">User {participant.userId.slice(0, 8)}</p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex justify-between items-center mb-2">
                    <p className="text-2xl font-bold text-gray-900">
                      {teamup.currentParticipants}/{teamup.maxParticipants}
                    </p>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-gray-900 capitalize">{teamup.durationType}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {!isOwner && user && teamup.status === 'open' && !isParticipant && (
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-2xl p-6">
                ...
                <button
                  ...
                  disabled={joining || teamup.currentParticipants >= teamup.maxParticipants}
                ...
                >
                  {joining ? 'Sending...' : teamup.currentParticipants >= teamup.maxParticipants ? 'TeamUp Full' : 'Send Join Request'}
                </button>
              </div>
            )}
